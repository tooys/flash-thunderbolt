		...
		public static function log (level: String, msg: String = "", logObjects: Array = null): void
		{
			if(!_hide)
			{
				...
				{					
					...
					{
						// @see http://www.nuff-respec.com/technology/determine-if-firebug-running
						if ( ExternalInterface.call("function(){ return window.console && console.firebug}") > 0 ) _firebug = true;
					}
					_firstRun = false;
				}
